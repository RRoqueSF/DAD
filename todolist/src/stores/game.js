...
export const useGameStore = defineStore('game', () => {
    ...
    const fetchGames = async () => {
        try {
            ...
            const errorMessage = e.response?.data?.message || e.message || 'Error fetching user games!';
            storeError.setErrorMessages(errorMessage, [], e.response?.status || 500, 'Error fetching games!');
        } 
    };
